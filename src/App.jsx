...
export default function App() {
  ...
  useEffect(() => {
    // cache: 'no-cache' — не «не кешировать», а «спросить, не изменился ли».
    // GitHub Pages отдаёт файл с max-age=600, и без этого оператор до десяти
    // минут видел бы вчерашние числа, а после обновления рейтингов — вообще
    // старые, пока не нажмёт Ctrl+F5. Запрос дешёвый: если файл тот же,
    // сервер отвечает «304, не изменился» без тела.
    fetch(assetUrl('/ratings.json'), { cache: 'no-cache' })
